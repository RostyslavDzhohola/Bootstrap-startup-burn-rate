...
export default function Header() {
  return (
    <header className="flex items-center justify-between px-6 py-4 bg-white/90 backdrop-blur-md border-b border-slate-200/80 fixed top-0 left-0 right-0 z-50 shadow-sm">
      {/* Left: Fire Icon */}
